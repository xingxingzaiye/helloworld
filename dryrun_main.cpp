...
int main() {
	...
	e1.handleParallelProcedureEvent(E1ProcessableMessage{e1setupreq}, IncomingEvent::e1SetupReq);
	//e1setup procedure ongoing, e1resetreq ignore
	e1.handleParallelProcedureEvent(E1ProcessableMessage{e1resetreq}, IncomingEvent::e1ResetReq);
	...
	f1.handleParallelProcedureEvent(F1ProcessableMessage{f1setupreq}, IncomingEvent::f1SetupReq);
